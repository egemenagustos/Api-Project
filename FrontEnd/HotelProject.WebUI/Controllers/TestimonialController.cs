...
namespace HotelProject.WebUI.Controllers
{
    public class TestimonialController : Controller
    {
        ...
        public async Task<IActionResult> AddTestimonial(TestimonialViewModel model)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:3490/api/Testimonial", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:3490/api/Testimonial/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:3490/api/Testimonial/{id}");
        ...
        public async Task<IActionResult> UpdateTestimonial(TestimonialViewModel model)
        {
            ...
            var responseMessage = await client.PutAsync($"http://localhost:3490/api/Testimonial/", content);
