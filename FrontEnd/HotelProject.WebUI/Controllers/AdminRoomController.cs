...
namespace HotelProject.WebUI.Controllers
{
    public class AdminRoomController : Controller
    {
        ...
        public async Task<IActionResult> AddRoom(CreateRoomDto model)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:3490/api/Room", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.DeleteAsync($"http://localhost:3490/api/Room/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"http://localhost:3490/api/Room/{id}");
        ...
        public async Task<IActionResult> UpdateRoom(UpdateRoomDto model)
        {
            ...
            var responseMessage = await client.PutAsync($"http://localhost:3490/api/Room/", content);
