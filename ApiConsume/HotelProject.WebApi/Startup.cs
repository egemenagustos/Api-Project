...
namespace HotelProject.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IServieceService, ServiceManager>();
            ...
            /* API'nin baþka kaynaklar tarafýndan tüketilmesiyle ilgili yaptýðýmýz konfigürasyon.*/
            services.AddCors(opt =>
            {
                opt.AddPolicy("OtelApiCors", opts =>
                {
                    opts.AllowAnyOrigin().AllowAnyHeader().AllowAnyMethod(); /* Herhangi bir kaynaða / baþlýða / methoda izin ver.*/
                });
            });
