        ...
        public async Task<IActionResult> Index(string cityId)
        {
            if (!string.IsNullOrEmpty(cityId))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?filter_by_currency=EUR&dest_id={cityId}&order_by=popularity&checkin_date=2023-09-23&dest_type=city&adults_number=2&room_number=1&checkout_date=2023-09-24&locale=en-gb&units=metric&include_adjacency=true&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&page_number=0&children_ages=5%2C0&children_number=2"),
                    Headers =
    {
